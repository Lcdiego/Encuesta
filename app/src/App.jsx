...
function App() {
  ...
  return (
    <div className="App">
      <h1>Diego colman</h1>
      <IconButton onClick={handleOpen}><span className='icono-izq'></span><span className='candidatos'>Elije tu candidato</span><span className='icono-der'><ArrowCircleRightOutlinedIcon/></span></IconButton>
      <Modal
        open={open}
        onClose={handleClose}
